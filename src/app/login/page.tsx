...
export default function LoginPage() {
  ...
  const { user, initialized, signInWithGoogle, signIn, loading } = useAuth()
            ...
            {showEmail ? (
              ...
              <>
                ...
                <div className="text-center mt-5 text-xs text-gray-500">
                  Belum punya akun?{' '}
                  <a href={redirectRef.current ? `/register?redirect=${encodeURIComponent(redirectRef.current)}` : '/register'} className="text-green-600 font-semibold hover:text-green-700">Daftar</a>
                </div>
              </>
            )}
          </div>
